...
module.exports.config = function (name, callback) {
...
module.exports.scp = function (params, callback) {

  return Promise.resolve().then(function () {
    return exec('docker-machine scp ' + params, {
      env: { 
        HOME: process.env.HOME,
        PATH: process.env.PATH,
        DEBUG: ''
...
module.exports.inspect = function (name, callback) {

  return Promise.resolve().then(function () {
    return exec('docker-machine inspect ' + name, {
      env: {
        HOME: process.env.HOME,
        PATH: process.env.PATH,
        DEBUG: ''
